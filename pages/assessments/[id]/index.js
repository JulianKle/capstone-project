    ...
    <DetailContainer>
      ...
      {highRiskExpanded && (
        <DetailsSection>
          <SubSection>
            <DetailParagraph>
              The AI Act introduces a graduated system of obligations according
            ...
            <DetailParagraph>
              ...
              systems on the EU market or putting them into service, regardless
              of their location.
            </DetailParagraph>
          </SubSection>
        </DetailsSection>
          ...
          <DetailsSection>
            <SubSection>
              <DetailParagraph>
                ...
                is a clear risk of manipulation (e.g. via the use of chatbots).
          ...
          <DetailsSection>
            <SubSection>
              ...
              <DetailParagraph>
                ...
                total computing power of more than 10^25 FLOPs are considered to
                carry systemic risks, given that models trained with larger
              ...
              <DetailParagraph>
                ...
                state-of-the-art tests and model evaluations, ensure
                cybersecurity and provide information on the energy consumption
                of their models.
              </DetailParagraph>
              <DetailParagraph>
                ...
                the rules in cooperation with other experts. A scientific panel
